...
class Test(unittest.TestCase):
    ...
    def testPopulateRandomly(self):
        board = self.golb.populateRandomly(10,10,0.5)
    ...
    def testPopulateShouldHandleIncorrectRatio(self):     
        #todo: fix!   
#         self.assertRaises(ValueError, self.golb.populateRandomly(10,10,2))
#         self.assertRaises(ValueError, self.golb.populateRandomly(10,10,-0.1))
        pass
    
    def testLoadFromFile(self):
        board = self.golb.populateFromFile("/home/eral/workspace/gameoflife-py/gol/test/miniboard.txt")
